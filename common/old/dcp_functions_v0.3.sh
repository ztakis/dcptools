...
# function start_init_combo {
#     confirm; echo; get_label; echo; get_sources "$1"
...
function more_label_only {
    label_disk
    diskprep_end
}

function more_bytecheck {
    confirm
    automount_disks
    bytecheck
}

function more_hashcheck_s {
    confirm
    get_sources single
    hashcheck -s
}
    ...
    "Label only" "Bytecheck" "Source hashcheck" "Main menu" "Exit"
        do
            case $opt in
                ...
                "Label only") echo; echo -e "${b_yellow}$opt${clear}"; more_label_only; break;;
                "Bytecheck") echo; echo -e "${b_yellow}$opt${clear}"; more_bytecheck; break;;
                "Source hashcheck") echo; echo -e "${b_yellow}$opt${clear}"; more_hashcheck_s; break;;
