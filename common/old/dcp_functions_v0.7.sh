...
function combo_main {
    ...
    main_menu
    if [ -s $temp/error.log ]; then
        echo; echo -e "${b_yellow}Errors reported! Check error.log for details${clear}"; echo
    fi
}